...
# Race name is in: dat$MRData$RaceTable$Races, to process it, put it a data frame and show as a table
df <- dat$MRData$RaceTable$Races %>% 
  as_tibble %>%
  print()

#In the Races dataframe, we want race names; In results dataframe (nested), 
