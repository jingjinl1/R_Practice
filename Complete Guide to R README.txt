...
This R project was created for the LinkedIn Learning course “Complete Guide to R.” This R project contains three folders:
...
In addition to these three folders, the following files are contained in the project folder:

- This README file.

- The “Complete Guide to R.Rproj” file that contains all of the project settings and links for use in the desktop versions of RStudio.
